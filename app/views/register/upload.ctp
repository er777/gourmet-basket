<?php echo $this->Form->create('Upload', array('url' => '/register/upload', 'id' => 'form_vendor')); ?>
...
<div style="width:650px;margin:auto;margin-top:30px;background-color:#FFF;padding:15px">
        <h1>Vendor Registration Part II</h1>
        <p> This form is for uploading data to your Gourmet-Basket Server.</p>
      ...
      <table width="400" align="left"class="input" style="color:#0c2c5a;">
          ...
          <tr>
              ...
              <td width="17" align="left">
                  <?php echo $this->Form->checkbox('shipping.gb_ups', array('value' => 1, 'label' => false, 'hiddenField' => false)); ?>
                  &nbsp;*</td>
          </tr>
          <tr>
              <td>FEDEX</td>
              <td align="left">
                  <?php echo $this->Form->checkbox('shipping.gb_fedex', array('value' => 1, 'label' => false, 'hiddenField' => false)); ?>
                  &nbsp;*</td>
          </tr>
          <tr>
              <td>USPS</td>
              <td align="left">
                  <?php echo $this->Form->checkbox('shipping.gb_usps', array('value' => 1, 'label' => false, 'hiddenField' => false)); ?>
                  &nbsp;*</td>
          </tr>
           ...
           <tr>
              <td>&nbsp;</td>
              <td align="left">
                  <?php echo $this->Form->checkbox('shipping.check_gb_shipping', array('value' => 1, 'label' => false, 'hiddenField' => false)); ?>
                  &nbsp;</td>
...
<br />
 ...
 <div align="left">Do you agree to the <a style="color:#C00;text-decoration:underline" href="">Standard Gourmet Basket Return Policy?</a> <strong>-->YES</strong><span>
        <?php echo $this->Form->checkbox('shipping.return_policy_check', array('value' => 1, 'label' => false, 'hiddenField' => false)); ?></span></div><br />
