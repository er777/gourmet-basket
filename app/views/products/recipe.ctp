...
?>
    <div class="content-product">
      ...
      <?php echo $html->image('../admin/images/product/'.($val['image']!=""?$val['image']:'default.png'), array('class' =>'resizeme', 'height' => '110px', 'width' => '100px','border' => '0', 'alt' => $val['description'], 'title' => $val['description'],   "url"=> array('controller' => 'products', 'action' => 'detail', 'id' => $val['product_id']))); ?>  
          
      </div>
          <a href="/products/detail/<?php echo $val['product_id'];?>">
              <div class="desc-price-wrapper">
                <span class="name"> <?php echo strlen($val['product_name'])>40?substr($val['product_name'],0,40)."...":$val['product_name'];?> </span>
                <div class="thumb-price"> $<?php echo $val['price'];?> </div>
              </div>
          </a> 
