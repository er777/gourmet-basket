...
-->
          ...
          <div id="upper-content">
             <div id="headlines">
                ...
                <div class="headline-2">
                   <div>
                      <h2> <a href="<?php echo $headline_home['headline_link2'];?>"> <?php echo $headline_home['headline_2'];?> </a> </h2>
                   </div>
                   <div></div>
                </div>
                <div class="headline-3">
                   <div>
                      <h2> <a href="<?php echo $headline_home['headline_link3'];?>"> <?php echo $headline_home['headline_3'];?> </a> </h2>
                   </div>
                   <div></div>
                </div>
                <div class="headline-4">
                   <div>
                      <h2> <a href="<?php echo $headline_home['headline_link4'];?>"> <?php echo $headline_home['headline_4'];?> </a> </h2>
                   </div>
                   <div></div>
                </div>
    ...
    <div id="lower">
       ...
       <div id="lower-wrapper">
        ...
        ?>
                         <li class="gb-feature" style="background-image: url('http://gourmet-basket.com/test/app/webroot/img/featured/<?php echo $slide['pic'];?>');" >
                            <div class="holder">
                               <h1 style="color: #ffffff; font-size: 20pt;"> <?php echo $slide['title'];?> </h1>
                               <p style="color: #fff;"> <?php echo $slide['description'];?> </p>
                               <div> <a class="button big" target="_blank" href="<?php echo $slide['link'];?>">Shop now</a> </div>
                            </div>
                         </li>
                         <?php
        }	
             ...
             <div class="additional">
                ...
                <div id="greeting-withjs" class="hide">
                   <div style="float: left; width: 380px; padding: 10px 10px 25px 10px;">
                      ...
                      <p style="width: 350px;"> Follow us <a href="<?php echo $headline_home['body_text_link'];?>">Read more</a> </p>
                   </div>
                   <div style="float: left; width: 270px; margin: 10px 0 10px; padding-left: 20px; border-left: 1px dotted #ccc; min-height:100px;" class="newsletter">
                      <div id="newsletterRegHomePage">
                         ...
                         <p class="instruct"> <span class="post_message hide"></span> 
                      ...
                      <div class="user_registration">
                         ...
                         <div id="user_registration_A">
                            <p class="instruct"> <span id="newsletter_copy"></span> <span class="post_message hide"><?php echo $headline_home['body_text_thanks'];?></span></p>
       ...
       foreach ($feature_block as $key => $block) {       
        ...
        ?>
             <div class="featured-item<?php echo $position;?>"> <a href="<?php echo $block['link'];?>"> <img src="http://gourmet-basket.com/test/app/webroot/img/featured/<?php echo $block['pic'];?>" width="293" height="266" alt="" /> </a>
                <div class="featured-item-desc">
                   ...
                   <div class="featured-item-desc"> <span class="price"><?php echo $block['price'];?></span><span class="description "><?php echo $block['description'];?></span> </div>
                </div>
             </div>
             <?php
        }	
