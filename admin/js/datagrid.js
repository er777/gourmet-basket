    ...
    else
    {
        ...
        switch(coldef["coltype"]) 
        {
            ...
            case 'select':
                ...
                if(coldef.selectvalues!=undefined) 
                    for(opt in coldef.selectvalues){
            ...
            //======================================================================
            case 'textarea':
                editContent = "<textarea " + onblur + " " + coldef["attributes"] +">" + dg_esc(me.m_oldval) + "</textarea>";
                cell.innerHTML = editContent;
                break;
            ...
            //======================================================================
            case 'text':
                editContent = "<input " + onblur + " type='text' size='15' value='" + dg_esc(me.m_oldval) + "' " + coldef["attributes"] +">";
                cell.innerHTML = editContent;
                break;
...
function dg_navigate(me,pos,sortcol){
    ...
    if(navElem!=undefined){
        navElem.innerHTML="Loading...";
        navElem.style.display = "inline-block";
    } 
