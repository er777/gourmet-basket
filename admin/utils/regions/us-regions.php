    ...
    <tr>   
        ...
        <table width="100%" border="0" cellpadding="4" cellspacing="4">     
            <tr>
                ...
                <td align="right" width="250"><a href="region_editor_us.php"><img src="images/add.png"></a>&nbsp;Add Region </td>
                ...
                <td>
                    <table class="tabledata" style="width:800px;" border="0" cellpadding="2" cellspacing="2">
                        <tr style="background:lightblue;">
                            ...
                            <th width="200">US Regions</th>
                            <th width="546">Region Article</th> 
                        </tr>
                    <?php
                        $query = "SELECT * FROM us_categories ORDER BY us_category";  
                        ...
                        id="row_<?php echo $row["us_category_id"]; ?>" 
                        onmouseover="switchClass('row_<?php echo $row["us_category_id"]; ?>', '<?php echo $bgcolor_op; ?>');"
                        onclick="location.href='region_editor_us.php?cmd=edit&cid=<?php echo $row["us_category_id"]; ?>'">

                        <!--    onclick="Modalbox.show('utils/category_editor.php?cmd=edit&cid=<?php echo $row["us_category_id"]; ?>', {title: 'Gourmet Basket - Category Editor', width:800, height: 600, aspnet: false}); return false;"> -->
                             <td valign="top"><?php echo $row["us_category_id"]; ?></td>
                             <td valign="top"><?php echo $row["us_category"]; ?></td>
                             <td valign="top"><div style="height:100px;overflow-y:scroll"><?php echo $row["us_category_summary"]; ?></div></td>
                             <td valign="top"><div style="height:100px;overflow-y:scroll"><?php echo $row["us_category_article"]; ?></div></td>
                        </tr>
                    <?php
                        $b++;
                    } ?>
