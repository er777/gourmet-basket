<div class="recipe-box-left">
        	<div class="recipe-info"><span class="recipe-label">Recipe #</span>
         	<input name="data[users_recipes][recipe_number]"  value="<?=$r['$recipe_number']?>" type="text" id="users_Recipe_number"/>
        	</div>
