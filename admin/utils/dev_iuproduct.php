...
<table border="0" cellpadding="4" cellspacing="2" >
    ...
    <tr>
        <td valign="top">
            ...
            <textarea rows="3" cols="24"  wrap="OFF" class="description" name="description" id="description"><?php echo $description;?></textarea>
        </td> 
    ...
    <tr>      
        ...
        Allergen Free<input type="checkbox" value="1" <?php echo  checked($allergen, 1) ?> name="allergen" id="allergen" />
