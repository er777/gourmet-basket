          ...
          <div class="tab_container">
            ...
            <div id="tab_2" style=" display: none;">
              <table style="width: 630px;">
                ...
                <td><?php echo (isset($p['aux_category_name']) ? $p['aux_category_name'] : ''); ?>xxx
                </td>
                </tr>
                ...
                <td>
                    ...
                    <option value="">Select</option>
                    		<?php echo DB::db_options("SELECT `aux_category_id`, `aux_category_name` FROM `product_aux_categories` order by `aux_category_name`", (isset($p['aux_category_id']) ? $p['aux_category_id'] : '')) ?>
                ...
                <tr> 
                <td>
                <select name="aux_category_2" id="aux_category_3" class="left">
                	<option value="">Select</option>
                    		<?php echo DB::db_options("SELECT `aux_category_id`, `aux_category_name` FROM `product_aux_categories` order by `aux_category_name`", (isset($p['aux_category_id']) ? $p['aux_category_id'] : '')) ?>
