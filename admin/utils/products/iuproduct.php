                            ...
                            <div id="tab_2" style=" display: none;">
                                ...
                                <table style="width: 630px;">
                                  ...
                                  <tr>      
                                        ...
                                        <td>
                                            <label>Domestic Areas where used</label> 
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="checkbox1">
                                                        ...
                                                        <tr>
                                                        <td> Allergen Free </td><td><input type="checkbox" value= <?php echo checked($p['allergen'], 1) ?> name="allergen" id="allergen" /></td>
                                                        <td> Gluten Free </td><td><input type="checkbox" value= <?php echo checked($p['gluten'], 1) ?> name="gluten" id="gluten" /></td>
                                                        <td> Vegan </td><td><input type="checkbox" value= <?php echo checked($p['vegan'], 1) ?> name="vegan" id="vegan" /></td>
                                                    </tr>
                                                    <tr>
